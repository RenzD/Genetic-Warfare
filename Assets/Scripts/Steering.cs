...
[RequireComponent(typeof(AIRigidbody))]
public class Steering : MonoBehaviour
{
   ...
   AIRigidbody rb;
    ...
    /// </summary>
    public Vector3 SeekEnemy(Vector3 targetPosition)
    {
        ...
        float targetSpeed;
        if (dist > enemySlowRadius)
        {
            targetSpeed = maxVelocity;
        }
        else
        {
            targetSpeed = maxVelocity * (dist / enemySlowRadius);
        }
        ...
        acceleration *= 1 / enemyTimeToTarget;
    ...
    public Vector3 Interpose(AIRigidbody target1, AIRigidbody target2)
    {
